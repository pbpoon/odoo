...
class StockMove(models.Model):
    ...
    weight_uom_id = fields.Many2one('product.uom', string='Weight Unit of Measure', related='product_id.weight_uom_id', help="Unit of Measure (Unit of Measure) is the unit of measurement for Weight")
