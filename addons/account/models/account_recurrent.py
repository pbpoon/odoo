...
class AccountRecurrentMixin(models.AbstractModel):
    ...
    is_recurrency_enabled = fields.Boolean(string="Generate Recurring Document(s)",
        help="Enable if you want to generate recurring document as per defined interval.", copy=False)
