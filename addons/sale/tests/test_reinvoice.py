...
class TestReInvoice(TestCommonSaleNoChart):
    ...
    def test_sales_price(self):
        ...
        self.assertEquals((sale_order_line5.price_unit, sale_order_line5.qty_delivered, sale_order_line5.product_uom_qty, sale_order_line5.qty_invoiced), (self.product_deliver_sales_price.list_price, invoice_lineA1.quantity + invoice_lineB1.quantity, 0, 0), 'Sale line is wrong after confirming 2e vendor invoice')
