...
class TestSetTags(TransactionCase):
    ...
    def test_set_tags_single_tag(self):
        ...
        self.assertEqual(fc.test_tags, {'at_install', 'base', 'slow'})
    ...
    def test_set_tags_multiple_tags(self):
        ...
        self.assertEqual(fc.test_tags, {'at_install', 'base', 'slow', 'nightly'})
    ...
    def test_inheritance(self):
        ...
        fc = FakeClassB()
        self.assertEqual(fc.test_tags, {'at_install', 'base', 'nightly'})
...
class TestSelector(TransactionCase):
    ...
    def test_selector(self):
        ...
        # not explicitly deselected with '-at_install' or if 'at_installs' is not
        ...
        self.assertTrue(tag_test_selector(multiple_tags_at_install_obj, ''))
    ...
    def test_selector_post_install(self):
        ...
        self.assertFalse(tag_test_selector(Test_B, 'slow,post_install,-at_install'))
        ...
        self.assertFalse(tag_test_selector(Test_B, 'fast,post_install,-at_install'))
        self.assertFalse(tag_test_selector(Test_C, 'fast,post_install,-at_install'))
        ...
        # with '--test-tags '-fast'
        self.assertTrue(tag_test_selector(Test_A, '-fast,-post_install'))
        self.assertFalse(tag_test_selector(Test_B, '-fast,-post_install'))
        self.assertFalse(tag_test_selector(Test_C, '-fast,-post_install'))
